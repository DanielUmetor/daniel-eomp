		...
		<div class="min-h-full mx-10">
			<div class="flex flex-col md:grid md:grid-cols-6 min-h-full">
				...
				<div class="col-span-4 flex-1 flex-col order-1 md:order-none">
					<div class="container mx-auto max-w-full 2xl:max-w-6xl">
						...
						<footer class="hidden text-center md:block mb-5">
							<p>🚀 Designed & Created by <a href="https://maximshelepov.com" class="hover:text-link-color" target="_blank">Daniel Umetor</a></p>
							<a href="https://github.com/DanielUmetor/daniel-eomp" class="hover:text-link-color" target="_blank"></a>
						</footer>
					</div>
				</div>
				...
				<footer class="block text-center text-sm md:hidden order-last mb-5">
					<p>🚀 Designed & Created by <a href="https://maximshelepov.com" class="hover:text-link-color" target="_blank">Daniel Umetor</a></p>
					<a href="https://github.com/feifyKike/webdev_portfolio" class="hover:text-link-color" target="_blank"></a>
				</footer>
			</div>
		</div>
	</div>
